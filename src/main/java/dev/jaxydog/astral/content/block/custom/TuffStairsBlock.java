 ...
 * @since 2.3.0
 */
public class TuffStairsBlock extends AstralStairsBlock implements Generated {
     ...
     * @since 2.3.0
     */
    public TuffStairsBlock(String path, BlockState baseBlockState, Settings settings) {
